namespace AstroClient.AstroMonos.Components.Cheats.Worlds.PrisonEscapeComponents
{
    ...
    public class PrisonEscape_HitboxReader : AstroMonoBehaviour
    {
        ...
        {
            Private___23_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__23_intnl_SystemBoolean");
            Private___0_const_intnl_VRCSDKBaseVRCPlayerApiTrackingDataType = new UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingDataType>(HitBox, "__0_const_intnl_VRCSDKBaseVRCPlayerApiTrackingDataType");
            Private___0_pos_Vector3 = new UdonVariable<UnityEngine.Vector3>(HitBox, "__0_pos_Vector3");
            Private___3_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__3_const_intnl_SystemString");
            Private___0_intnl_PlayerData = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__0_intnl_PlayerData");
            Private___0_const_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__0_const_intnl_SystemBoolean");
            Private___1_intnl_UnityEngineQuaternion = new UdonVariable<UnityEngine.Quaternion>(HitBox, "__1_intnl_UnityEngineQuaternion");
            Private___1_const_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__1_const_intnl_SystemInt32");
            Private___0_intnl_PlayerObjectPool = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__0_intnl_PlayerObjectPool");
            Private___1_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__1_intnl_SystemInt32");
            Private___2_intnl_SystemObject = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__2_intnl_SystemObject");
            Private___0_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__0_const_intnl_SystemString");
            Private___1_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__1_intnl_SystemSingle");
            Private_minHeight = new UdonVariable<float>(HitBox, "minHeight");
            Private___0_this_intnl_UnityEngineTransform = new UdonVariable<UnityEngine.Transform>(HitBox, "__0_this_intnl_UnityEngineTransform");
            Private___5_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__5_intnl_SystemBoolean");
            Private___0_const_intnl_exitJumpLoc_UInt32 = new UdonVariable<uint>(HitBox, "__0_const_intnl_exitJumpLoc_UInt32");
            Private___15_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__15_intnl_SystemBoolean");
            Private___1_intnl_VRCSDKBaseVRCPlayerApi = new UdonVariable<VRC.SDKBase.VRCPlayerApi>(HitBox, "__1_intnl_VRCSDKBaseVRCPlayerApi");
            Private_poolIndex = new UdonVariable<int>(HitBox, "poolIndex");
            Private___6_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__6_const_intnl_SystemString");
            Private___21_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__21_intnl_SystemBoolean");
            Private___13_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__13_intnl_SystemBoolean");
            Private___1_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__1_const_intnl_SystemString");
            Private___5_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__5_intnl_SystemSingle");
            Private___0_parentObj_GameObject = new UdonVariable<UnityEngine.GameObject>(HitBox, "__0_parentObj_GameObject");
            Private___1_intnl_SystemInt32Array = new UdonVariable<int[]>(HitBox, "__1_intnl_SystemInt32Array");
            Private___16_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__16_intnl_SystemBoolean");
            Private___7_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__7_intnl_SystemBoolean");
            Private___1_intnl_SystemInt64 = new UdonVariable<long>(HitBox, "__1_intnl_SystemInt64");
            Private___22_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__22_intnl_SystemBoolean");
            Private___0_intnl_UnityEngineComponentArray = new UdonVariable<UnityEngine.Component[]>(HitBox, "__0_intnl_UnityEngineComponentArray");
            Private___7_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__7_const_intnl_SystemString");
            Private___refl_const_intnl_udonTypeID = new UdonVariable<long>(HitBox, "__refl_const_intnl_udonTypeID");
            Private___4_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__4_intnl_SystemBoolean");
            Private___1_height_Single = new UdonVariable<float>(HitBox, "__1_height_Single");
            Private___19_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__19_intnl_SystemBoolean");
            Private___refl_const_intnl_udonTypeName = new UdonVariable<string>(HitBox, "__refl_const_intnl_udonTypeName");
            Private_Root = new UdonVariable<UnityEngine.Transform>(HitBox, "Root");
            Private___0_intnl_SystemObject = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__0_intnl_SystemObject");
            Private___1_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__1_intnl_SystemBoolean");
            Private___4_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__4_const_intnl_SystemString");
            Private___11_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__11_intnl_SystemBoolean");
            Private___2_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__2_intnl_SystemInt32");
            Private___2_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__2_intnl_SystemSingle");
            Private___0_mp_headHeight_Single = new UdonVariable<float>(HitBox, "__0_mp_headHeight_Single");
            Private___5_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__5_const_intnl_SystemString");
            Private___3_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__3_intnl_SystemBoolean");
            Private___0_headData_TrackingData = new UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingData>(HitBox, "__0_headData_TrackingData");
            Private___0_intnl_returnValSymbol_Boolean = new UdonVariable<bool>(HitBox, "__0_intnl_returnValSymbol_Boolean");
            Private___12_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__12_intnl_SystemBoolean");
            Private_maxHeight = new UdonVariable<float>(HitBox, "maxHeight");
            Private___0_intnl_UnityEngineGameObjectArray = new UdonVariable<UnityEngine.GameObject[]>(HitBox, "__0_intnl_UnityEngineGameObjectArray");
            Private___0_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__0_intnl_SystemBoolean");
            Private_Head = new UdonVariable<UnityEngine.Transform>(HitBox, "Head");
            Private___1_intnl_PlayerData = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__1_intnl_PlayerData");
            Private___3_intnl_SystemObject = new UdonVariable<int[]>(HitBox, "__3_intnl_SystemObject");
            Private___0_intnl_UnityEngineGameObject = new UdonVariable<UnityEngine.GameObject>(HitBox, "__0_intnl_UnityEngineGameObject");
            Private___8_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__8_const_intnl_SystemString");
            Private___6_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__6_intnl_SystemSingle");
            Private___0_intnl_UnityEngineQuaternion = new UdonVariable<UnityEngine.Quaternion>(HitBox, "__0_intnl_UnityEngineQuaternion");
            Private_playerData = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "playerData");
            Private___0_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__0_intnl_SystemInt32");
            Private___0_intnl_returnTarget_UInt32 = new UdonVariable<uint>(HitBox, "__0_intnl_returnTarget_UInt32");
            Private___0_height_Single = new UdonVariable<float>(HitBox, "__0_height_Single");
            Private___0_mp_playerHeight_Single = new UdonVariable<float>(HitBox, "__0_mp_playerHeight_Single");
            Private___0_const_intnl_SystemUInt32 = new UdonVariable<uint>(HitBox, "__0_const_intnl_SystemUInt32");
            Private___9_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__9_intnl_SystemBoolean");
            Private_leeway = new UdonVariable<float>(HitBox, "leeway");
            Private___0_intnl_VRCSDKBaseVRCPlayerApiTrackingData = new UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingData>(HitBox, "__0_intnl_VRCSDKBaseVRCPlayerApiTrackingData");
            Private___0_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__0_intnl_SystemSingle");
            Private___0_mp_damage_Int32 = new UdonVariable<int>(HitBox, "__0_mp_damage_Int32");
            Private___3_intnl_UnityEngineVector3 = new UdonVariable<UnityEngine.Vector3>(HitBox, "__3_intnl_UnityEngineVector3");
            Private___6_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__6_intnl_SystemBoolean");
            Private___0_player_VRCPlayerApi = new UdonVariable<VRC.SDKBase.VRCPlayerApi>(HitBox, "__0_player_VRCPlayerApi");
            Private___4_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__4_intnl_SystemSingle");
            Private___1_intnl_VRCSDK3ComponentsVRCObjectPool = new UdonVariable<VRC.SDK3.Components.VRCObjectPool>(HitBox, "__1_intnl_VRCSDK3ComponentsVRCObjectPool");
            Private___0_intnl_VRCSDKBaseVRCPlayerApi = new UdonVariable<VRC.SDKBase.VRCPlayerApi>(HitBox, "__0_intnl_VRCSDKBaseVRCPlayerApi");
            Private___14_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__14_intnl_SystemBoolean");
            Private___0_intnl_SystemInt64 = new UdonVariable<long>(HitBox, "__0_intnl_SystemInt64");
            Private___3_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__3_intnl_SystemInt32");
            Private___8_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__8_intnl_SystemBoolean");
            Private___20_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__20_intnl_SystemBoolean");
            Private___2_intnl_UnityEngineVector3 = new UdonVariable<UnityEngine.Vector3>(HitBox, "__2_intnl_UnityEngineVector3");
            Private___1_intnl_SystemObject = new UdonVariable<VRC.SDK3.Components.VRCObjectPool>(HitBox, "__1_intnl_SystemObject");
            Private___1_intnl_UnityEngineVector3 = new UdonVariable<UnityEngine.Vector3>(HitBox, "__1_intnl_UnityEngineVector3");
            Private___2_const_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__2_const_intnl_SystemInt32");
            Private___3_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__3_intnl_SystemSingle");
            Private___0_intnl_UnityEngineVector3 = new UdonVariable<UnityEngine.Vector3>(HitBox, "__0_intnl_UnityEngineVector3");
            Private___0_intnl_UnityEngineTransform = new UdonVariable<UnityEngine.Transform>(HitBox, "__0_intnl_UnityEngineTransform");
            Private___1_const_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__1_const_intnl_SystemBoolean");
            Private___0_const_intnl_SystemInt64 = new UdonVariable<long>(HitBox, "__0_const_intnl_SystemInt64");
            Private___18_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__18_intnl_SystemBoolean");
            Private___2_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__2_intnl_SystemBoolean");
            Private___7_intnl_SystemSingle = new UdonVariable<float>(HitBox, "__7_intnl_SystemSingle");
            Private_gameManager = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "gameManager");
            Private___10_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__10_intnl_SystemBoolean");
            Private___2_const_intnl_SystemString = new UdonVariable<string>(HitBox, "__2_const_intnl_SystemString");
            Private___0_intnl_returnValSymbol_Single = new UdonVariable<float>(HitBox, "__0_intnl_returnValSymbol_Single");
            Private___1_const_intnl_SystemInt64 = new UdonVariable<long>(HitBox, "__1_const_intnl_SystemInt64");
            Private___0_const_intnl_SystemInt32 = new UdonVariable<int>(HitBox, "__0_const_intnl_SystemInt32");
            Private___1_intnl_PlayerObjectPool = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__1_intnl_PlayerObjectPool");
            Private___17_intnl_SystemBoolean = new UdonVariable<bool>(HitBox, "__17_intnl_SystemBoolean");
            Private___0_intnl_UnityEngineComponent = new UdonVariable<VRC.Udon.UdonBehaviour>(HitBox, "__0_intnl_UnityEngineComponent");
            Private___0_playerId_Int32 = new UdonVariable<int>(HitBox, "__0_playerId_Int32");
        }
        ...
        private UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingDataType> Private___0_const_intnl_VRCSDKBaseVRCPlayerApiTrackingDataType { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<UnityEngine.Vector3> Private___0_pos_Vector3 { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.Udon.UdonBehaviour> Private___2_intnl_SystemObject { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private_minHeight { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<UnityEngine.Transform> Private___0_this_intnl_UnityEngineTransform { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<int> Private_poolIndex { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<UnityEngine.GameObject> Private___0_parentObj_GameObject { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<int[]> Private___1_intnl_SystemInt32Array { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private___1_height_Single { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<UnityEngine.Transform> Private_Root { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private___0_mp_headHeight_Single { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingData> Private___0_headData_TrackingData { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private_maxHeight { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<UnityEngine.Transform> Private_Head { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<VRC.Udon.UdonBehaviour> Private___1_intnl_PlayerData { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<int[]> Private___3_intnl_SystemObject { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.Udon.UdonBehaviour> Private_playerData { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private___0_height_Single { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<float> Private___0_mp_playerHeight_Single { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private_leeway { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        private UdonVariable<VRC.SDKBase.VRCPlayerApi.TrackingData> Private___0_intnl_VRCSDKBaseVRCPlayerApiTrackingData { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.SDKBase.VRCPlayerApi> Private___0_player_VRCPlayerApi { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.SDKBase.VRCPlayerApi> Private___0_intnl_VRCSDKBaseVRCPlayerApi { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<VRC.SDK3.Components.VRCObjectPool> Private___1_intnl_SystemObject { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<UnityEngine.Transform> Private___0_intnl_UnityEngineTransform { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<float> Private___0_intnl_returnValSymbol_Single { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
        ...
        private UdonVariable<int> Private___0_playerId_Int32 { [HideFromIl2Cpp] get; [HideFromIl2Cpp] set; } = null;
