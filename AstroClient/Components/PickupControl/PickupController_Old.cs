namespace AstroClient.Components
{
    ...
    public class PickupController_Old : GameEventsBehaviour
    {
        public PickupController_Old(IntPtr ptr) : base(ptr)
        {
        }
        ...
        public void Start()
        {
            ...
            Locked = false;
            ModConsole.DebugLog("Attacked Successfully PickupController_Old to object " + gameObject.name);
        }
        ...
        public void Update()
        {
            ...
            {
                ModConsole.DebugError("Error in PickupController_Old Bound to : " + gameObject.name);
        ...
        {
            ModConsole.DebugLog("PickupController_Old Got Destroyed from " + gameObject.name);
        }
