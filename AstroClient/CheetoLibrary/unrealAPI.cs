    ...
    internal class QMStuff
    {
        ...
        {
            QMStuff.GetQuickMenuInstance()._menuStateController.PushPage(pagename);
        }

        internal static void ShowQuickmenuPage(int index)
        {

            QMStuff.GetQuickMenuInstance()._menuStateController.SwitchToRootPage(index);
        }
    ...
    internal class QMWings : QMButtonBase
    {
        ...
        internal void initButton(int Index, bool LeftWing, string MenuName,  String btnToolTip, Color? btnBackgroundColor = null, string LoadSprite = "")
        {
            if(LeftWing)
            {
                ...
                Wing_UP_1.Name = btnQMLoc;
                Wing_UP_1.gameObject.name = btnQMLoc;
                Wing_UP_1._inited = true;
                Wing_UP_1._menuStateController = QMStuff.WingMenuStateControllerLeft();
                Wing_UP_1._pageStack = new Il2CppSystem.Collections.Generic.List<UIPage>();
                Wing_UP_1._pageStack.Add(Wing_UP_1);
                QMStuff.WingMenuStateControllerLeft()._uiPages.Add(btnQMLoc, Wing_UP_1);
                ...
                setAction(() => { QMStuff.Wing_Left().menuController.PushPage(btnQMLoc); });
            }
            else
            {
                btnQMLoc += "_RIGHT";
                ...
                Wing_UP_1.gameObject.name = btnQMLoc;
                Wing_UP_1._inited = true;
                Wing_UP_1._menuStateController = QMStuff.WingMenuStateControllerRight();
                Wing_UP_1._pageStack = new Il2CppSystem.Collections.Generic.List<UIPage>();
                Wing_UP_1._pageStack.Add(Wing_UP_1);
                QMStuff.WingMenuStateControllerRight()._uiPages.Add(btnQMLoc, Wing_UP_1);
                //Wing_UP_1.gameObject.CleanButtonsWingMenu();
                ...
                setAction(() => { QMStuff.Wing_Right().menuController.PushPage(btnQMLoc); });
            }
    ...
    internal class QMToggleButton : QMButtonBase
    {
        ...
        private protected void initButton(System.Action btnActionOn, float btnXLocation, float btnYLocation, string Title, System.Action btnActionOff, string btnToolTip,  string TextColor = null, bool shouldSaveInConf = false, bool defaultPosition = false)
        {
            ...
            button.NewText("Text_H4").text = Title;
    ...
    internal class QMNestedButton
    {
        ...
        internal void initButton(float btnXLocation, float btnYLocation, string btnText, string btnToolTip, string Title,  string LoadSprite = "", string TextColor = null,bool CanBeDragged = false)
        {
            ...
            Page_UI.Name = menuName;
            Page_UI._inited = true;
            Page_UI._menuStateController = QMStuff.QuickMenuController();
            Page_UI._pageStack = new Il2CppSystem.Collections.Generic.List<UIPage>();
            Page_UI._pageStack.Add(Page_UI);
            ...
            QMStuff.QuickMenuController()._uiPages.Add(menuName, Page_UI);
    ...
    public class QMButtonBase
    {
        ...
        {
            button.GetComponent<VRC.UI.Elements.Tooltips.UiTooltip>().text = buttonToolTip;
        }
    ...
    internal class QMSingleButton : QMButtonBase
    {
        ...
        private protected void initButton2(GameObject Parent, string btnText, System.Action btnAction, String btnToolTip, bool IsToggle = false)
        {
            ...
            button.AddComponent<VRC.UI.Elements.Tooltips.UiTooltip>().text = btnToolTip;
    ...
    internal static class Extensions
    {
        internal static void LoadSprite(this GameObject Parent, string LoadSprite, string name)
        {
            foreach (var image in Parent.GetComponentsInChildren<Image>(true))
            {
                if (image.name == name)// allows background image change
                {
                    ...
                    image.overrideSprite = LoadAssets.LoadSprite(LoadSprite);
        ...
        public static void EnableComponents(this GameObject parent)
        {
            ...
            UnityEngine.GameObject.Destroy(parent.GetComponent<VRC.UI.Elements.Buttons.VoteKickUserButton>());
        }
        ...
        internal static void CreateMainBackButton(this GameObject NestedPart)
        {
            ...
            {
                QMStuff.GetQuickMenuInstance()._menuStateController._currentRootPage.enabled = true;
                QMStuff.GetQuickMenuInstance()._menuStateController.SwitchToRootPage("QuickMenuDashboard");
            }));
        }
