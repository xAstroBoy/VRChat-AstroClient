namespace AstroClient.Tools.UdonEditor
{
    ...
    {
        internal static System.Collections.IEnumerator DisassembleProgram(string path, IUdonProgram program)
        {
        ...
        internal static string DisassembleInstruction(IUdonProgram program, ref uint offset)
        {
