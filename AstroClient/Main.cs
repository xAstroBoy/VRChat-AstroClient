	...
	public class Main : MelonMod
	{
		...
		public static void InitMainsButtons(float x, float y, bool btnHalf)
		{
			if (KeyManager.IsAuthed == true)
			{
				...
				ToggleHideAvatar = new QMSingleToggleButton(AstroClient, 4, 1.5f, "Hide Avatar ON", () => { Flight.NoClipEnabled = true; }, "Hide Avatar OFF", new Action(() => { AvatarHider.HideAvatar = false; }), "Hides your avatar for yourself", UnityEngine.Color.green, UnityEngine.Color.red, null, false, true);
				...
				{
					ToggleFly = new QMSingleToggleButton(AstroClient, 0, 0, "Fly", () => { Flight.FlyEnabled = true; }, "Fly", () => { Flight.FlyEnabled = false; }, "Enable/Disable Flight", UnityEngine.Color.green, UnityEngine.Color.red, null, Flight.FlyEnabled, true);
