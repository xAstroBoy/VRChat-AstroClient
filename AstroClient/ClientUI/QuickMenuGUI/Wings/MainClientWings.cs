...
namespace AstroClient.ClientUI.QuickMenuGUI.Wings
{
    ...
    internal class MainClientWings
    {
        ...
        internal static void InitMainWing()
        {
            ...
            new QMWingSingleButton(menu, "Join Instance", () => { new PortalInternal().Method_Private_Void_String_String_TextMeshProUGUI_PDM_0(Clipboard.GetText().Split(':')[0], Clipboard.GetText().Split(':')[1], new TextMeshProUGUI()); }, "Join an instance via your clipboard.");
