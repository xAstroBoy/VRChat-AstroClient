...
namespace AstroClient.AntiCrash
{
	...
	public class VRCAntiCrash_InitButtons : GameEvents
	{
		...
		public static void InitButtons(QMNestedButton menu, float x, float y, bool btnHalf)
		{
			...
			new QMSingleToggleButton(menu, 2, 0, "NoClip", () => { }, "NoClip", () => { }, "Toggle NoClip With VR Support", Color.green, Color.red, null, false, true);
			...
			new QMSingleToggleButton(menu, 1, 1, "Rainbow ESP", () => { }, "Rainbow ESP", () => { }, "Toggle Rainbow ESP , Make the border of anything you hower rainbow.", Color.green, Color.red, null, false, true);
			new QMSingleToggleButton(menu, 2, 1, "Anti-Spawn Shit", () => { }, "Anti-Spawn Shit", () => { }, "Toggle Anti-Spawn Shit , Make avatar with intros such as audio or particles not show.", Color.green, Color.red, null, false, true);
			new QMSingleToggleButton(menu, 3, 1, "Player Collision", () => { }, "Player Collision", () => { }, "Toggle Player Collision , Make Players who walk into you be able to push you.", Color.green, Color.red, null, false, true);
			new QMSingleToggleButton(menu, 4, 1, "Anti-Lewd", () => { }, "Anti-Lewd", () => { }, "Toggle Anti-Lewd , Make Avatars with Easily recognizable lewd objects such as toggleable Dicks not show.", Color.green, Color.red, null, false, true);

			new QMSingleToggleButton(menu, 1, 1.5f, "Anti Portal Enter", () => { }, "Anti Portal Enter", () => { }, "Toggle Anti Portal Enter , Make You only able to enter portals by you or friends Depending on allow friends Option & Auto Deletes Portals on enter.", Color.green, Color.red, null, false, true);
