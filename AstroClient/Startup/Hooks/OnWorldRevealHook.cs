...
namespace AstroClient.Startup.Hooks
{
    ...
    internal class OnWorldRevealHook : AstroEvents
    {
        ...
        {
            new AstroPatch(HarmonyLib.AccessTools.Method(typeof(VRCUiManager), nameof(VRCUiManager.Method_Public_Void_String_Single_Action_1)), GetPatch(nameof(OnFadeEvent)));
            
        }

        private static void OnFadeEvent(string __0, float __1, Il2CppSystem.Action __3)
        {
            string fadeType = __0;
            float duration = __1;
