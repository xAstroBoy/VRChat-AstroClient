    ...
    public class QuickMenuHooks : GameEvents
    {
        ...
        private void HookSelectedPlayer()
        {
            try
            {
                ...
                _ = harmony1.Patch(AccessTools.Method(typeof(QuickMenu), nameof(QuickMenu.Method_Public_Void_Player_0)), new HarmonyMethod(typeof(QuickMenuHooks).GetMethod(nameof(OnSelectedPlayerPatch), BindingFlags.Static | BindingFlags.NonPublic)), null, null);
