...
namespace AstroClient.Startup.Hooks
{
    ...
    internal class PlayerJoinAndLeaveHook : AstroEvents
    {
        ...
        private void VRChat_OnUiManagerInit()
        {
            ...
            field0.field_Private_HashSet_1_UnityAction_1_T_0.Add(new Action<Player>((player) => { if (player != null) ClientEventActions.Event_OnPlayerJoin?.SafetyRaiseWithParams(player); }));
            field1.field_Private_HashSet_1_UnityAction_1_T_0.Add(new Action<Player>((player) => { if (player != null) ClientEventActions.Event_OnPlayerLeft?.SafetyRaiseWithParams(player); }));
