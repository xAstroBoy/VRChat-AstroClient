...
namespace AstroClient.GameObjectDebug
{
    public class GameObjectUtils
    {
        ...
        public static void GrabbableGameObjDumper()
        {
            ...
            new Thread(() =>
            {
                string path = @"C:\Users\xAstroBoy\Desktop\xAstroBoyVRChatClient\" + RoomManager.field_Internal_Static_ApiWorld_0.name.ToString() + "_VRCPickup.txt";
                Thread.CurrentThread.IsBackground = true;
        ...
        public static void GameObjectDumper()
        {
            ...
            new Thread(() =>
            {
                string path = @"C:\Users\xAstroBoy\Desktop\xAstroBoyVRChatClient\" + RoomManager.field_Internal_Static_ApiWorld_0.name.ToString() + " gameobjects.txt";
                Thread.CurrentThread.IsBackground = true;
        ...
        public static void GameObjDumperWithComponents()
        {
            ...
            string path = @"C:\Users\xAstroBoy\Desktop\xAstroBoyVRChatClient\" + RoomManager.field_Internal_Static_ApiWorld_0.name.ToString() + "_GameObjects_With_components.txt";
