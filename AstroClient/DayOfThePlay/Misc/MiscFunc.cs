namespace DayClientML2.Utility
{
	...
	internal class MiscFunc
	{
		...
		internal static void Lewdify(GameObject avatar, bool ForceLewdify)
		{
			foreach (SkinnedMeshRenderer componentsInChild in avatar.GetComponentsInChildren<SkinnedMeshRenderer>(includeInactive: true))
			{
				...
				foreach (string item in TermsToToggleOn)
				{
					if ((componentsInChild.transform.parent.parent.parent.parent.name.ToLower().Contains(item) || (componentsInChild.transform.parent.parent.parent.parent.parent != null && componentsInChild.transform.parent.parent.parent.parent.parent.name.ToLower().Contains(item))) && componentsInChild.transform.parent.gameObject != null)
					{
						...
						if (componentsInChild.transform.parent.parent.parent.parent.GetComponent<Animator>() != null)
						{
							...
							ModConsole.Log("[Lewdify] Disabled Animator On Toggle: " + componentsInChild.transform.parent.parent.parent.parent.name);
						}
						if (componentsInChild.GetComponent<Animator>() != null)
						{
							componentsInChild.GetComponent<Animator>().enabled = false;
							ModConsole.Log("[Lewdify] Disabled Animator On Renderer Inside Toggle: " + componentsInChild.transform.parent.parent.parent.parent.name);
						}
						ModConsole.Log("[Lewdify] Enabled Lewd Skinned Mesh Toggle: " + componentsInChild.transform.parent.parent.parent.parent.name);
					}
				}
				foreach (string item2 in TermsToToggleOff)
				{
					if (componentsInChild.transform.parent.parent.parent.parent.name.ToLower().Replace("nsfw", "").Contains(item2) && componentsInChild.transform.parent.gameObject != null)
					{
						...
						if (ForceLewdify)
						{
							ModConsole.Log("[Lewdify] Destroyed Non-Lewd Skinned Mesh Toggle: " + componentsInChild.transform.parent.parent.parent.parent.name);
							UnityEngine.Object.Destroy(componentsInChild.transform.parent.gameObject);
						}
						else
						{
							ModConsole.Log("[Lewdify] Disabled Non-Lewd Skinned Mesh Toggle: " + componentsInChild.transform.parent.parent.parent.parent.name);
							componentsInChild.transform.parent.gameObject.SetActive(value: false);
						}
					}
				}
			}
			foreach (MeshRenderer componentsInChild2 in avatar.GetComponentsInChildren<MeshRenderer>(includeInactive: true))
			{
				...
				foreach (string item3 in TermsToToggleOn)
				{
					if ((componentsInChild2.transform.parent.parent.parent.parent.name.ToLower().Contains(item3) || (componentsInChild2.transform.parent.parent.parent.parent.parent != null && componentsInChild2.transform.parent.parent.parent.parent.parent.name.ToLower().Contains(item3))) && componentsInChild2.transform.parent.gameObject != null)
					{
						...
						if (componentsInChild2.transform.parent.parent.parent.parent.GetComponent<Animator>() != null)
						{
							...
							ModConsole.Log("[Lewdify] Disabled Animator On Toggle: " + componentsInChild2.transform.parent.parent.parent.parent.name);
						}
						if (componentsInChild2.GetComponent<Animator>() != null)
						{
							componentsInChild2.GetComponent<Animator>().enabled = false;
							ModConsole.Log("[Lewdify] Disabled Animator On Renderer Inside Toggle: " + componentsInChild2.transform.parent.parent.parent.parent.name);
						}
						ModConsole.Log("[Lewdify] Enabled Lewd Mesh Toggle: " + componentsInChild2.transform.parent.parent.parent.parent.name);
					}
				}
				foreach (string item4 in TermsToToggleOff)
				{
					if (componentsInChild2.transform.parent.parent.parent.parent.name.ToLower().Replace("nsfw", "").Contains(item4) && componentsInChild2.transform.parent.gameObject != null)
					{
						...
						if (ForceLewdify)
						{
							ModConsole.Log("[Lewdify] Destroyed Non-Lewd Skinned Mesh Toggle: " + componentsInChild2.transform.parent.parent.parent.parent.name);
							UnityEngine.Object.Destroy(componentsInChild2.transform.parent.gameObject);
						}
						else
						{
							ModConsole.Log("[Lewdify] Disabled Non-Lewd Skinned Mesh Toggle: " + componentsInChild2.transform.parent.parent.parent.parent.name);
							componentsInChild2.transform.parent.gameObject.SetActive(value: false);
						}
					}
				}
			}
