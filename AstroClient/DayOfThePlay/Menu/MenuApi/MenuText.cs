...
namespace DayClientML2.Utility
{
    public class MenuText
    {
        ...
        {
            menuTitle = UnityEngine.Object.Instantiate<GameObject>(QuickMenuStuff.GetQuickMenuInstance().transform.Find("ShortcutMenu/EarlyAccessText").gameObject, menuBase.getBackButton().getGameObject().transform.parent);
