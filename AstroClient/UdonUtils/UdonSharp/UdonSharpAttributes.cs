...
namespace AstroClient.UdonUtils.UdonSharp
{
    ...
    {
        public UdonSyncInterpolationMethod networkSyncType;

        public UdonSyncedAttribute(UdonSyncInterpolationMethod networkSyncTypeIn = UdonSyncInterpolationMethod.None)
        {
