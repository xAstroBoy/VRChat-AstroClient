namespace AstroClient.Experiments
{
    ...
    internal class CameraTweaker : GameEvents
    {
        ...
        internal static void InitQMMenu(QMTabMenu tab, float x, float y, bool btnHalf)
        {
            ...
            IsCameraFreeToggle = new QMSingleButton(tmp, 1, 1.5f, "Free Camera", () => { IsCameraFree = true; }, "Parented Camera", () => { IsCameraFree = false; }, "Set if Camera needs to be bound or freed from you.", Color.green, Color.red, null, false, true);
            RespawnOnLevelChangeToggle = new QMSingleButton(tmp, 1, 2f, "Reset Camera on Level Change", () => { RespawnCameraOnLevelLoad = true; }, "Reset Camera on Level Change", () => { RespawnCameraOnLevelLoad = false; }, "Resets Camera Position to be in front of you on level changes.", Color.green, Color.red, null, false, true);
        ...
        private static QMSingleButton RespawnOnLevelChangeToggle;
        private static QMSingleButton IsCameraFreeToggle;
