...
namespace AstroClient.febucci.Core
{
    ...
    public abstract class TAnimPlayerBase : MonoBehaviour
    {
        ...
        public TAnimPlayerBase(IntPtr obj0) : base(obj0)
        {
        ...
        public TextAnimator textAnimator
        {
            get
            {
                ...
                _textAnimator = this.gameObject.GetOrAddComponent<TextAnimator>();
        ...
        /// <summary>
        /// plays all remaining events once the typewriter has been skipped
        /// </summary>
        ...
        /// <summary>
        /// resets the typewriter speed every time a new text is set/shown
        /// </summary>
        bool resetTypingSpeedAtStartup = true;
        ...
        bool CanStartAnyCoroutine()
        {
            ...
            {
                Log.Warn("TextAnimator: couldn't start coroutine because the gameobject is not active");
                return false;
            }
            return true;
        }
        ...
        public void StartShowingText(bool resetVisibleCharacters = false)
        {
            ...
            if (!useTypeWriter)
            {
                Log.Warn("TextAnimator: couldn't start coroutine because 'useTypewriter' is disabled");
                return;
            }
            ...
            {
                StartCoroutine(nameof(ShowRemainingCharacters));
            }
        }
        ...
        public void StartDisappearingText()
        {
            ...
            {
                Log.Warn("TextAnimatorPlayer: Can't start disappearance routine in the opposite direction of the typewriter, because you're still showing the text! (the typewriter might get stuck trying to show and override letters that keep disappearing)");
                return;
            }
