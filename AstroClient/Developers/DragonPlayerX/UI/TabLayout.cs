...
namespace AstroClient.DragonPlayerX.UI
{
    ...
    {
        internal static TabLayout Instance;
        ...
        public TabLayout(IntPtr value) : base(value)
        {
            ...
            quickMenu = QuickMenuTools.Canvas_QuickMenu.gameObject;
            ...
            if (MelonHandler.Mods.Any(mod => mod.Info.Name.Equals("Styletor")))
            {
                ...
                Log.Write("Found Styletor. Style tag was applied to the tab background.");
            }
            else
            {
                ...
                if (tabSprite != null)
                    Log.Write("Found sprite: " + tabSprite.name);
                else
                    Log.Warn("Unable to find the Page_Tab_Backdrop sprite.");
        ...
        public void ApplySorting(bool applyDefault = false)
        {
            ...
            Dictionary<string, Il2CppSystem.ValueTuple<Transform, UIPage>> tabs = new Dictionary<string, Il2CppSystem.ValueTuple<Transform, UIPage>>();
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                if (child.gameObject.name != "Background_QM_PagePanel")
                {
                    ...
                    if (menuStateController.field_Private_Dictionary_2_String_UIPage_0.ContainsKey(pageKey))
                    {
                        ...
                        tabs.Add(uiPage.field_Public_String_0, new Il2CppSystem.ValueTuple<Transform, UIPage>(child, uiPage));
                    }
                    else
                    {
                        Log.Warn("Menu tab \"" + pageKey + "\" has no UIPage.");
                    }
                }
            }
