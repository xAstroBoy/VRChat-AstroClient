...
namespace AstroClient.HookedBehemoth.WorldCleanup.UI
{
    static class UiExpansion
    {
        ...
        private static IEnumerator LoadUiElements()
        {
            ...
            {
                var asset = ClientResources.Loaders.Bundles.WorldCleanup.LoadAsset<T>(path);
            ...
            {
                var bundle_object = ClientResources.Loaders.Bundles.WorldCleanup.LoadAsset<GameObject>(str);
