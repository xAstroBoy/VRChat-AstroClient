...
using AstroClient.HookedBehemoth.WorldCleanup;
using AstroClient.HookedBehemoth.WorldCleanup.UI;
using MelonLoader;
using UnityEngine;
...
{
    internal class WorldCleanupMod : AstroEvents
    {
        internal override void RegisterToEvents()
        {
            ClientEventActions.OnApplicationStart += ApplicationStart;
            ClientEventActions.OnApplicationQuit += OnApplicationQuit;
            ClientEventActions.OnSceneLoaded += OnSceneWasInitialized;
        }
        ...
        private  void ApplicationStart()
        {
            ...
            RegisterAvatarCallback((Il2CppSystem.Action<Player, GameObject, VRC_AvatarDescriptor>)OnAvatarInstantiate);
