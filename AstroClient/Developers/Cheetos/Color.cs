...
public struct Color
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0057:Use range operator", Justification = "Ugly")]
    public Color(string hexColor)
    {
        ...
        {
            //#RGB
            R = byte.Parse(hexColor[0].ToString() + hexColor[0].ToString(), NumberStyles.AllowHexSpecifier);
            G = byte.Parse(hexColor[1].ToString() + hexColor[1].ToString(), NumberStyles.AllowHexSpecifier);
            B = byte.Parse(hexColor[2].ToString() + hexColor[2].ToString(), NumberStyles.AllowHexSpecifier);
        }
        A = 255;
    }
    ...
    {
        t = Math.Mathf.Clamp01(t);
        var R = (byte)Math.Mathf.Lerp(a.R, b.R, t);
        var G = (byte)Math.Mathf.Lerp(a.G, b.G, t);
        var B = (byte)Math.Mathf.Lerp(a.B, b.B, t);
        var A = (byte)Math.Mathf.Lerp(a.A, b.A, t);
        return new(R, G, B, A);
    }
    ...
    public class HTML
    {
        ...
        public static readonly Color Lime = Green;
