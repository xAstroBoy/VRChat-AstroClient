...
namespace Apollo.Utils.API.Wings
{
    public class WingToggle
    {
        ...
        public WingToggle(BaseWing wing, string name, Transform parent, int pos, Color on, Color off, bool initial, System.Action<bool> onClick)
        {
            this.wing = wing;
