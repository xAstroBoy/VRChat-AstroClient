...
public class CheetoElement
{
	...
	public VRC.UI.Elements.Tooltips.UiTooltip ToolTip
	{
		get
		{
			...
			var attempt1 = Self.GetComponent<VRC.UI.Elements.Tooltips.UiTooltip>();
			if (attempt1 == null)
			{
				attempt1 = Self.GetComponentInChildren<VRC.UI.Elements.Tooltips.UiTooltip>(true);
			}
			if (attempt1 == null)
			{
				attempt1 = Self.AddComponent<VRC.UI.Elements.Tooltips.UiTooltip>();
			}
