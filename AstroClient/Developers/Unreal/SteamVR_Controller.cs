...
namespace AstroClient.Unreal
{
    public class SteamVR_Controller
    {
        public class ButtonMask
        {
            ...
            public const ulong ButtonB = (1ul << (int)EVRButtonId.k_EButton_B);
            public const ulong IndexJoystick = (1ul << (int)EVRButtonId.k_EButton_IndexController_JoyStick);
            public const ulong IndexButtonB = (1ul << (int)EVRButtonId.k_EButton_IndexController_B);
            public const ulong IndexButtonA = (1ul << (int)EVRButtonId.k_EButton_IndexController_A);
        }
        ...
        public class Device
        {
            ...
            public Vector3 Position { get { Update(); return new Vector3(pose.mDeviceToAbsoluteTracking.m3, pose.mDeviceToAbsoluteTracking.m7, -pose.mDeviceToAbsoluteTracking.m11); } }
            ...
            public void Update()
            {
                if (Time.frameCount != prevFrameCount)
                {
                    ...
                    if (system != null)
                    {
                        valid = system.GetControllerStateWithPose((ETrackingUniverseOrigin)SteamVR_Render.field_Private_Static_SteamVR_Render_0.field_Public_ETrackingUniverseOrigin_0, index, ref state, (uint)Marshal.SizeOf(typeof(VRControllerState_t)), ref pose);
                        UpdateHairTrigger();
                    }
                }
            }

            public bool GetPress(ulong buttonMask) { Update();/* Console.WriteLine(state.ulButtonPressed);*/ return (state.ulButtonPressed & buttonMask) != 0; }
        ...
        internal static Vector3 vectorC;
        ...
        public static int GetDeviceIndex(DeviceRelation relation, ETrackedDeviceClass deviceClass = ETrackedDeviceClass.Controller, int relativeTo = (int)OpenVR.k_unTrackedDeviceIndex_Hmd) // use -1 for absolute tracking space
        {
            ...
            for (int i = 0; i < OpenVR.k_unMaxTrackedDeviceCount; i++)
            {
                ...
                vectorC = invXform * device.transform.pos;
