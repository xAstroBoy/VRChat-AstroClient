    ...
    internal class VRChat_LoadingScreenObjects
    {
        ...
        internal static GameObject VRChat_UIRoot
        {
            get
            {
                ...
                {
                    return _VRChat_UIRoot = Finder.Find($"{QuickMenuTools.UserInterface.name}/MenuContent/Popups/LoadingPopup");
                }
        ...
        internal static GameObject VRChat_loginBubbles
        {
            get
            {
                ...
                {
                    return _VRChat_loginBubbles = Finder.Find($"{QuickMenuTools.UserInterface.name}/LoadingBackground_TealGradient_Music/_FX_ParticleBubbles");
                }
        ...
        internal static GameObject VRChat_StartScreen
        {
            get
            {
                ...
                {
                    return _VRChat_StartScreen = Finder.Find($"{QuickMenuTools.UserInterface.name}/LoadingBackground_TealGradient_Music");
                }
        ...
        internal static GameObject VRChat_originalStartScreenAudio
        {
            get
            {
                ...
                {
                    return _VRChat_originalStartScreenAudio = Finder.Find($"{QuickMenuTools.UserInterface.name}/LoadingBackground_TealGradient_Music/LoadingSound");
                }
        ...
        internal static GameObject VRChat_originalStartScreenSkyCube
        {
            get
            {
                ...
                {
                    return _VRChat_originalStartScreenSkyCube = Finder.Find($"{QuickMenuTools.UserInterface.name}/LoadingBackground_TealGradient_Music/SkyCube_Baked");
                }
