namespace AstroClient.xAstroBoy.UIPaths
{
    ...
    internal class VRChatObjects
    {
        ...
        public static GameObject SettingsTitleText { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/TitlePanel/TitleText").gameObject; } }
        public static GameObject SettingsVersionText { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/TitlePanel/VersionText").gameObject; } }
        public static GameObject SettingsAudioSlider { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/AudioDevicePanel/VolumeSlider").gameObject; } }
        public static GameObject SettingsAudioSelectPrevMic { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/AudioDevicePanel/SelectPrevMic").gameObject; } }
        public static GameObject SettingsAudioSelectNextMic { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/AudioDevicePanel/SelectNextMic").gameObject; } }
        public static GameObject SettingsNameText { get { return GameInstances.VRCUiManager.GetMenuContent().transform.Find("Screens/Settings/Footer/NameText").gameObject; } }
