namespace AstroClient.xAstroBoy.Extensions
{
    ...
    public static class PlayerExtensions
    {
        ...
        public static string GetThings(this VRCPlayer Instance)
        {
            ...
            if (Instance.GetUserID() != APIUser.CurrentUser.id && GameInstances.ModerationManager.GetIsBlocked(Instance.GetUserID()) && GameInstances.ModerationManager.GetIsBlockedByUser(Instance.GetUserID()))
                returnstring += "<color=magenta>[B]</color> ";

            if (Instance.GetUserID() != APIUser.CurrentUser.id && GameInstances.ModerationManager.GetIsBlocked(Instance.GetUserID()))
                returnstring += "<color=cyan>[B]</color> ";

            if (Instance.GetUserID() != APIUser.CurrentUser.id && GameInstances.ModerationManager.GetIsBlockedByUser(Instance.GetUserID()))
