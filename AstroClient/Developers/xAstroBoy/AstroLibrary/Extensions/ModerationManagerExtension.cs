    ...
    public static class ModerationManagerExtension
    {
        ...
        public static bool GetIsBlockedByUser(this VRC.Management.ModerationManager instance, string UserID)
        {
            foreach (var kvp in PlayerModerations)
            {
                ...
                foreach (var moderation in moderations)
                {
                    if (moderation.moderationType == ApiPlayerModeration.ModerationType.Block && moderation.sourceUserId == UserID && moderation.targetUserId == GameInstances.CurrentUser.GetUserID())
                    {
                        return true;
                    }
                }
        ...
        private static Dictionary<string, List<ApiPlayerModeration>> PlayerModerations
        {
            get
            {
                return GameInstances.ModerationManager.field_Private_Dictionary_2_String_List_1_ApiPlayerModeration_0;
            }
            set
            {
                GameInstances.ModerationManager.field_Private_Dictionary_2_String_List_1_ApiPlayerModeration_0 = value;
            }
        }
        ...
        private static Dictionary<string, List<ApiModeration>> GlobalModerations
        {
            get
            {
                return GameInstances.ModerationManager.field_Private_Dictionary_2_String_List_1_ApiModeration_0;
            }
            set
            {
                GameInstances.ModerationManager.field_Private_Dictionary_2_String_List_1_ApiModeration_0 = value;
            }
        }
    }
}