namespace AstroClient.xAstroBoy.AstroButtonAPI
{
    ...
    internal class QmQuickActions
    {
        ...
        internal void initButton(int Index, string Menu, string Title, Color32 TextColor)
        {
            ...
            {
                case "MainMenu":
                    Header = UnityEngine.Object.Instantiate(QuickMenuTools.Header_DashboardTemplate().gameObject, QuickMenuTools.Header_DashboardTemplate().parent, true);
                    ...
                    QuickActions = UnityEngine.Object.Instantiate(QuickMenuTools.MenuDashboard_ButtonsSection().gameObject, QuickMenuTools.Header_DashboardTemplate().parent, true);
                ...
                case "SelectedUser":
                    Index += 5;
                    Header = UnityEngine.Object.Instantiate(QuickMenuTools.Header_DashboardTemplate().gameObject, QuickMenuTools.SelectedUserPage().parent, true);
                    Header.name = QMButtonAPI.identifier + btnType + Title + "_Header";
                    ...
                    QuickActions = UnityEngine.Object.Instantiate(QuickMenuTools.SelectedUserPage_ButtonsSection().gameObject, QuickMenuTools.SelectedUserPage().parent, true);
                    QuickActions.CleanButtonsQuickActions();
                    QuickActions.GetComponentInChildren<RectTransform>().SetSiblingIndex(Index + 1);
                    QuickActions.name = QMButtonAPI.identifier + btnType + Title + "_Buttons";
                    break;
