namespace AstroClient.ItemTweakerV2.Submenus
{
    ...
    internal class SpinnerSubMenu : Tweaker_Events
    {
        internal static  void Init_SpinnerSubMenu(QMNestedButton menu, float x, float y, bool btnHalf)
        {
            ...
            _ = new QMSingleButton(submenu, 2, 2, "Remove all Spinner Objects", new Action(ObjectSpinnerManager.KillObjectSpinners), "Removes all Spinner components from objects!", null, null);
