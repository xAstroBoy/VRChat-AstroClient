namespace AstroClient.ItemTweakerV2.Submenus
{
	...
	public class ObjectInfoSubMenu : Tweaker_Events
	{
		public static void Init_ObjectInfoSubMenu(QMTabMenu menu, float x, float y, bool btnHalf)
		{
			...
			new QMSingleButton(main, 1, 0f, "Copy Local Position.", () => { Tweaker_Object.GetGameObjectToEdit().CopyLocalPosition(); }, "Copies Object Current Local Position in clipboard.", null, Color.yellow, true);
			new QMSingleButton(main, 1, 0.5f, "Copy Position.", () => { Tweaker_Object.GetGameObjectToEdit().CopyPosition(); }, "Copies Object Current Position in clipboard.", null, Color.yellow, true);
			new QMSingleButton(main, 1, 1f, "Copy Rotation.", () => { Tweaker_Object.GetGameObjectToEdit().CopyRotation(); }, "Copies Object Current Rotation in clipboard.", null, Color.yellow, true);
			...
			CurrentObjectCoordsBtn = new QMSingleButton(main, 4, -1, "", null, "Shows Object Coords", null, null, false);
