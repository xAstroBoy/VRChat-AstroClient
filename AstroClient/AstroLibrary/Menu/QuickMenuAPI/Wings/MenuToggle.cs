...
{
    internal class MenuToggle : UIElement
    {
        ...
        private static GameObject TogglePrefab
        {
            get
            {
                if (_togglePrefab == null)
                {
                    ...
                    _togglePrefab = ExtendedQuickMenu.Instance.transform
        ...
        private static Sprite OnIconSprite
        {
            get
            {
                ...
                {
                    _onIconSprite = ExtendedQuickMenu.Instance.transform
        ...
        public MenuToggle(string name, string text, string tooltip, Action<bool> onToggle, Transform parent, bool defaultValue = false) : base(TogglePrefab, parent, $"Button_Toggle{name}")
        {
            ...
            _toggleComponent.onValueChanged.AddListener(new Action<bool>(toggleIcon.field_Public_Toggle_0));
