...
{
    internal class WingButton : UIElement
    {
        [Flags]
        ...
        private static Wing[] Wings
        {
            get
            {
                if (_wings == null || _wings.Length == 0)
                {
                    ...
                    _wings = QMStuff.GetQuickMenuInstance().GetComponentsInChildren<Wing>(true);
                }
        ...
        protected WingButton(string text, Action onClick, bool left = true, bool arrow = true, bool background = true,
            ...
            bool seperator = false)
        {
            ...
            {
                var wingButton = new WingButton(text, onClick, true, arrow, background, seperator);
            }
            if ((wingSide & WingSide.Right) == WingSide.Right)
            {
                var wingButton = new WingButton(text, onClick, false, arrow, background, seperator);
            }
        }
    }
}
