...
namespace Apollo.Utils.API.QM
{
    ...
    public class Tab
    {
        ...
        public Tab(string menuName, string tooltip, Sprite icon = null)
        {
            gameObject = Object.Instantiate(APIStuff.GetMenuTabTemplate(), APIStuff.GetMenuTabTemplate().transform.parent);
