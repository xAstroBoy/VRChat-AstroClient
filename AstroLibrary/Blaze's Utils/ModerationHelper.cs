...
namespace DayClientML2.Modules.Misc
{
	...
	public class ModerationHelper
    {
        ...
        {
            var Moderation = Modules.Misc.ModerationHelper.GetModeration(userid, null, false);
            if (Moderation != null)
            {
        ...
        {
            var SavePath = FileManager.MiscPath + "\\Moderations.json";
        ...
        {
            var LogPath = FileManager.MiscPath + "\\ModerationsLog.Json";
